        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ControlQuestions_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonBlock_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControlQuestionId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionOptions_ControlQuestions_ControlQuestionId",
                        column: x => x.ControlQuestionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCorrect = table.Column<bool>(type: "boolean", nullable: false),
                    LessonBlockId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizOption", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizOption_LessonBlock_LessonBlockId",
                        column: x => x.LessonBlockId,
                        principalTable: "LessonBlock",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ControlQuestions_LessonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptions_ControlQuestionId",
                table: "QuestionOptions",
                column: "ControlQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizOption_LessonBlockId",
                table: "QuizOption",
                column: "LessonBlockId");
        }
